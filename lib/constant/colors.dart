...
class color{
  static Color loaderColor = Color(0xFF9E8ABF);
}
class MyColors{
  ...
  static Color grayText = Color(0xFFbababa);
  ...
  static Color blackcolor = Color(0xCC737373);
  static Color purple = Color(0xFF9e8abf);
  static Color transparent = Colors.transparent;
  static Color darkpurple = Color(0xFF800080);
  static Color lightpurple = Color(0xFFbf80ff);
  static Color lightblue = Color(0xFFcbb3e6);
